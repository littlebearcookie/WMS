...
manageRequest.interceptors.response.use(response => {
  store.commit("loaded", false);
  return response;
}, error => {
  store.commit("loaded", false);
...
guestRequest.interceptors.response.use(response => {
  store.commit("loaded", false);
  return response;
}, error => {
  store.commit("loaded", false);
...
export const apiEditWedding = (id, data) => manageRequest.put('/weddings/' + id, data);
...
export const apiEditGuest = (id, data) => manageRequest.put('/guests/' + id, data);
